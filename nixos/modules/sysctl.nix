...

{
    ...
    kernel.sysctl."vm.dirty_bytes" = 268435456;

    # Optimize storage related settings
    # Contains, as a bytes of total available memory that contains free pages and reclaimable
    # pages, the number of pages at which the background kernel flusher threads will start writing out
    # dirty data.
    kernel.sysctl."vm.dirty_background_ratio" = 5;
    kernel.sysctl."vm.dirty_ratio" = 10;
    ...
    kernel.sysctl."fs.file-max" = 2097152;

    # Increase writeback interval  for xfs
    kernel.sysctl."fs.xfs.xfssyncd_centisecs" = 10000;
    ...
    kernel.sysctl."kernel.sched_rt_runtime_us" = 980000;
    ...
    kernel.sysctl."net.core.somaxconn" = 8192;
