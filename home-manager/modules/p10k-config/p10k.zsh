# Generated by Powerlevel10k configuration wizard on 2023-01-29 at 04:26 CET.
...
# blurred heads, flat tails, 2 lines, dotted, right frame, light-ornaments, sparse,
...
() {
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=254
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND='#A01F34'
  # Custom icon.
